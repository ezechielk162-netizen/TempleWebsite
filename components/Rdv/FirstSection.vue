      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 mb-4 mb-lg-0">
          <p class="contact-description">
            Nous serions heureux de vous accompagner, de prier avec vous ou de répondre à
            vos questions. Communiquez avec nous par téléphone, WhatsApp ou via notre
            formulaire de contact. Notre équipe est là pour vous écouter, vous encourager
            et marcher avec vous dans la foi.
          </p>
          ...
          <div class="contact-item">
            ...
            <div>
              ...
              <p class="mt-3 mb-3">Chaque dimanche matin de 10:30 – 12:30 pm</p>
              <p class="mb-3">Chaque 3ème dimanche soir de 6:00 pm – 8:00 pm</p>
              <p class="mb-3">Chaque vendredi soir de 7:00 pm – 9:00 pm</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-6">
          <div class="map-container shadow-lg">
            <img
              src="https://maps.googleapis.com/maps/api/staticmap?center=Ottawa&zoom=13&size=800x500&maptype=roadmap"
              alt="Google Map"
